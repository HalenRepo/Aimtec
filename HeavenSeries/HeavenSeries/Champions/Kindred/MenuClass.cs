...
namespace HeavenSeries.Champions.Kindred
{
    ...
    internal static class MenuClass
    {
        ...
        public static Menu rsettingsmenu { get; set; }

        public static Menu rwhitelist { get; set; }
        ...
        public static Menu JungleClearq { get; set; }
        public static Menu JungleClearw { get; set; }
        public static Menu JungleCleare { get; set; }
