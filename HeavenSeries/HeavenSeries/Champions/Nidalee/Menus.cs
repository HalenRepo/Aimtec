        ...
        public void Menus()
        {
            ...
            Champions.Nidalee.MenuClass.Root = new Menu("HeavenSeries", "HeavenSeries - Nidalee", true);
            {
                ...
                Champions.Nidalee.MenuClass.combomenu = new Menu("combo", "Combo");
                {
                    ...
                    Champions.Nidalee.MenuClass.combocatmenu = new Menu("cat", "cat");
                    {
                ...
                Champions.Nidalee.MenuClass.junglemenu = new Menu("jungle", "Jungle");
                {
                    ...
                    {
                        Champions.Nidalee.MenuClass.junglehumanmenu.Add(new MenuBool("useq", "Use Q"));
                        Champions.Nidalee.MenuClass.junglehumanmenu.Add(new MenuBool("usew", "Use W"));
                        Champions.Nidalee.MenuClass.junglehumanmenu.Add(new MenuBool("usee", "Use E"));
                    ...
                    Champions.Nidalee.MenuClass.junglecatmenu = new Menu("cat", "cat");
                    {
